...
final v2RepoProvider = Provider<V2Repository>((ref) => V2Repository(ref.watch(firestoreProvider)));
...
final topicsForSelectedSegmentProvider = FutureProvider<List<Topic>>((ref) async {
...
final featuredProductsProvider = FutureProvider.family<List<Product>, String>((ref, listId) async {
  final repo = ref.watch(v2RepoProvider);
...
final productsByTopicProvider = FutureProvider.family<List<Product>, String>((ref, topicId) async {
...
final previewItemsProvider = FutureProvider.family<List<ContentItem>, String>((ref, productId) async {
  final repo = ref.watch(v2RepoProvider);

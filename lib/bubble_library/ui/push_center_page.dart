...
class PushCenterPage extends ConsumerWidget {
    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('已重排未來 3 天推播')));
            },
          ),
        ],
      ),
      body: ListView(
        ...
        children: [
          ...
          const Text('推播中', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
            ...
            data: (products) {
              return libAsync.when(
                data: (lib) {
                  ...
                  if (pushing.isEmpty) {
                    return BubbleCard(child: Text('目前沒有推播中的商品', style: TextStyle(color: Colors.white.withOpacity(0.8))));
                  }
                  return Column(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('頻率：${lp.pushConfig.freqPerDay}/天｜模式：${lp.pushConfig.timeMode.name}',
  ...
  Widget _globalCard(BuildContext context, WidgetRef ref, GlobalPushSettings g) {
    ...
    return BubbleCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('全域設定', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
          ...
          ListTile(
            ...
            trailing: DropdownButton<int>(
              ...
              items: const [6, 8, 12, 20].map((e) => DropdownMenuItem(value: e, child: Text('$e'))).toList(),
              onChanged: (v) async {
                if (v == null) return;
          ...
          Text('更改設定後會自動重排未來 3 天推播', style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 12)),
        ],
      ),
    );
  }
